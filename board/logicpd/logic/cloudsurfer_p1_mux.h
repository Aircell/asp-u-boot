...
/* Tarr - LCD Power Enable */
	MUX_VAL(CP(MCBSP4_FSX), (IDIS  | PTD | DIS | M4)); /*GPIO_155*/

/* Tarr - Green enable */
	MUX_VAL(CP(MCBSP1_CLKR), (IDIS | PTU | EN | M4)); /*GPIO_156*/

/* Tarr - Unused MCSP1 pins to GPIO */
    MUX_VAL(CP(MCBSP1_FSR), (IEN | PTU | DIS  | M4)); /*GPIO_157*/
...
/* Tarr - I2C 1 - TSP65950 Control */
	MUX_VAL(CP(I2C1_SCL), (IEN  | PTU | EN  | M0)); /*I2C1_SCL*/
	MUX_VAL(CP(I2C1_SDA), (IEN  | PTU | EN  | M0)); /*I2C1_SDA*/

/* Tarr - I2C 2 - Battery Pack */
	MUX_VAL(CP(I2C2_SCL), (IEN  | PTU | EN  | M0)); /*I2C2_SCL*/
	MUX_VAL(CP(I2C2_SDA), (IEN  | PTU | EN  | M0)); /*I2C2_SDA*/

/* Tarr - I2C 3 - Touch Screen and LogicPD Product ID*/
