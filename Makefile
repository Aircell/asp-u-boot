...
dm3730logic_config:	unconfig
	$(MKCONFIG) $(@:_config=) arm arm_cortexa8 logic ti omap3

cloudsurfer_config:	unconfig
	$(MKCONFIG) $(@:_config=) arm arm_cortexa8 cloudsurfer aircell omap3
